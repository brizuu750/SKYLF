...
class Variometro //la clase que va a usarse en el codigo, el variometro en este caso
{
    ...
    public void ConectarSimConnect() //se conecta al api
    {
        ...
        {
            Console.WriteLine("Error al conectar SimConnect en Variometro: " + ex.Message); //mensajes en caso de error de conexion
        }
        catch (Exception ex)
        {
            Console.WriteLine("Error inesperado en Variometro: " + ex.Message);//mensaje en caso de error del variometro
        }
    }
    ...
    public void ReceiveMessage()//funcion para recibir los datos/mensajes del api
    {
        ...
        {
            Console.WriteLine("Error al recibir mensaje en Variometro: " + ex.Message); //en caso de error al recibir los datos muestra este mensaje
        }
    }
    ...
    private void Simconnect_OnRecvSimobjectData(SimConnect sender, SIMCONNECT_RECV_SIMOBJECT_DATA data)
    {
        try
        {
            ...
            Console.WriteLine($"Velocidad vertical: {verticalSpeedData.VerticalSpeed} pies por minuto"); //en caso de que la conexion sea exitosa muestra el dato de la variable verticalSpeedData.VerticalSpeed
        }
        catch (Exception ex)
        {
            Console.WriteLine("Error al procesar datos del variometro: " + ex.Message);//en caso de error al procesar los datos de la variable
        }
    }
